        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() !== false) {
                ...
                $clientid = $this->clients_model->add([
                      'billing_street'      => checkIsset($data,'address'),
                      'billing_city'        => checkIsset($data,'city'),
                      'billing_state'       => checkIsset($data,'state'),
                      'billing_zip'         => checkIsset($data,'zip'),
                      'billing_country'     => $countryId,
                      'firstname'           => checkIsset($data,$fields['firstname']),
                      'lastname'            => checkIsset($data,$fields['lastname']),
                      'email'               => checkIsset($data,$fields['email']),
                      'contact_phonenumber' => checkIsset($data,'contact_phonenumber') ,
                      'website'             => checkIsset($data,'website'),
                      'password'            => checkIsset($data,'password'),
                      'company'             => checkIsset($data,$fields['company']),
                      'vat'                 => isset($data['vat']) ? $data['vat'] : '',
                      'phonenumber'         => checkIsset($data,'phonenumber'),
                      'country'             => checkIsset($data,'country'),
                      'city'                => checkIsset($data,'city'),
                      'address'             => checkIsset($data,'address'),
                      'zip'                 => checkIsset($data,'zip'),
                      'state'               => checkIsset($data,'state'),
