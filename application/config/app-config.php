...
*
*/
define('APP_BASE_URL', 'https://crm.original.softvalley.net/');
...
*/
define('APP_ENC_KEY', 'f1c7405efe038551968ec4bf63db3998');
 ...
 */
//define('APP_DB_USERNAME', 'softvall_softvall');
define('APP_DB_USERNAME', 'root');
/**
 * The password used to connect to the database
 */
//define('APP_DB_PASSWORD', 'F5W7Ug[Hu@=C');
define('APP_DB_PASSWORD', '');
/**
 * The name of the database you want to connect to
 */
//define('APP_DB_NAME', 'softvall_original_crm');
define('APP_DB_NAME', 'original_crm');
